//
//  JobExperienceDetailsViewController.swift
//  Forsa
//
...
class JobExperienceDetailsViewController: UITableViewController {
    ...
    func saveDataToFirebase() {
        // Safely unwrap optional fields
           ...
           db.collection("JobExperienceDetails").addDocument(data: dataToSave) { error in
               if let error = error {
    ...
    func fetchJobExperienceDetailsData() {
        db.collection("JobExperienceDetails").getDocuments { snapshot, error in
            if let error = error {
